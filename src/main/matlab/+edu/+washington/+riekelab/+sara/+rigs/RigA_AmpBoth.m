classdef RigA_AmpBoth < edu.washington.riekelab.sara.rigs.RigA

	methods
		function obj = RigA_AmpBoth()
			...
			amp2 = MultiClampDevice('Amp2', 1).bindStream(daq.getStrem('ao1')).bindStream(daq.getStream('ai1'));
			obj.addDevice(amp1);
			obj.addDevice(amp2);
