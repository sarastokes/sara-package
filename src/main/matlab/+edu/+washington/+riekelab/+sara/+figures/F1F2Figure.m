        ...
        function handleEpoch(obj, epoch)
            ...
            if numel(quantities) > 0
                ...
                if strcmp(obj.onlineAnalysis, 'spikes')
                    ...
                    y = zeros(size(y));
                    y(res.sp) = 1;
                    y = BinSpikeRate(y(prePts+1:end), obj.BINRATE, sampleRate);
                else
                    if prePts > 0
                    ...
                    y = binData(y(prePts+1:end), obj.BINRATE, sampleRate);
                end
            ...
            obj.handles.f1 = line(obj.xval, obj.F1,...
                'Parent', obj.axesHandle(1),...
                'Color', getPlotColor(obj.chromaticClass),...
                'Marker', 'o');
            if obj.showF2
                obj.handles.f2 = line(obj.xval, obj.F2,...
                    'Parent', obj.axesHandle(1),...
                    'Color', getPlotColor(obj.chromaticClass, 0.5),...
                    'Marker', 'o');
            end
            obj.handles.p1 = line(obj.xval, obj.P1,...
                'Parent', obj.axesHandle(2),...
                'Color', getPlotColor(obj.chromaticClass), 'Marker', 'o');
            
            set(obj.axesHandle(1), 'XLim', [min(obj.xval) max(obj.xval)]);
            set(obj.axesHandle(2), 'XLim', [min(obj.xval) max(obj.xval)]);
