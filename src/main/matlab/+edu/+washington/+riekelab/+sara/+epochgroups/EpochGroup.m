classdef (Abstract) EpochGroup < symphonyui.core.persistent.descriptions.EpochGroupDescription
    ...
    methods
        function obj = EpochGroup()
            ...
            obj.addProperty('recordingType', 'extracellular',...
                'type', PropertyType('char', 'row',...
                {'extracellular', 'voltage_clamp', 'current_clamp'}));
            obj.addProperty('pipetteType', int32(0),...
                'type', PropertyType('int32', 'scalar', [0 21 22 23 47 48]));
