classdef FilterWheelDevice < symphonyui.core.Device
    ...
    methods
        function obj = FilterWheelDevice(varargin)
            ...
            ip.addParameter('LEDs', 'RBU', @ischar);
            ip.parse(varargin{:});
            ...
            obj.addConfigurationSetting('LEDs', ip.Results.LEDs);
            ...
            obj.addConfigurationSetting('UV_L', 0.0);
            obj.addConfigurationSetting('UV_M', 0.0);
            obj.addConfigurationSetting('UV_S', 0.0);
            % obj.addConfigurationSetting('UV_rod', 0.0);
        ...
        function connect(obj, comPort)
            try
                obj.filterWheel = serial(comPort,...
        ...
        function setLEDs(obj, l)
          obj.setReadOnlyConfigurationSetting('LEDs', l);
        end

        function l = getLEDs(obj)
          l = obj.getConfigurationSetting('LEDs');
        end
