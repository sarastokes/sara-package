    ...
    methods
        ...
        function obj = Primate()
            ...
            photoreceptors('lCone') = struct( ...
                'collectingArea', 0.37, ...
                'spectrum', importdata(riekelab.sara.Package.getResource( ...
                'photoreceptors', 'primate', 'l_cone_spectrum.txt')));
            photoreceptors('mCone') = struct( ...
                'collectingArea', 0.37, ...
                'spectrum', importdata(riekelab.sara.Package.getResource( ...
                'photoreceptors', 'primate', 'm_cone_spectrum.txt')));
            photoreceptors('rod') = struct( ...
                'collectingArea', 1.00, ...
                'spectrum', importdata(riekelab.sara.Package.getResource( ...
                'photoreceptors', 'primate', 'rod_spectrum.txt')));
            photoreceptors('sCone') = struct( ...
                'collectingArea', 0.37, ...
                'spectrum', importdata(riekelab.sara.Package.getResource( ... 
                'photoreceptors', 'primate', 's_cone_spectrum.txt')));
