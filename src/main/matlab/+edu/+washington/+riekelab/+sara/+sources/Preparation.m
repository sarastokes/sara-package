        ...
        function obj = Preparation()
            ...
            obj.addProperty('region', {}, ...
                'type', PropertyType('cellstr', 'row',... 
                    {'fovea', 'parafovea', 'macula', 'central', 'peripheral',... 
                    'temporal', 'nasal', 'dorsal', 'ventral'}));
            obj.addProperty('preparation', 'whole mount, RGCs up', ...
                'type', PropertyType('char', 'row',... 
                    {'', 'shredded retina', 'whole mount, cones up',... 
                    'whole mount, RGCs up', 'slice'}),...
                'isPreferred', true);
