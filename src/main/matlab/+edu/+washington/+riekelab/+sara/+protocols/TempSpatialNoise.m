classdef SpatialNoise < edu.washington.riekelab.manookin.protocols.ManookinLabStageProtocol
    properties
        ...
        checkSpikes = false             % check spike detection
        demoMode = false
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            obj.showFigure('edu.washington.riekelab.manookin.figures.SpatialNoiseFigure', ...
            ...
            if obj.demoMode
                obj.showFigure('edu.washington.riekelab.sara.figures.SpatialNoiseFigure', ...
                obj.rig.getDevice(obj.amp),'recordingType', obj.onlineAnalysis, 'stixelSize', obj.stixelSize,...
                'numXChecks', obj.numXChecks, 'numYChecks', obj.numYChecks,...
                'noiseClass', obj.noiseClass, 'chromaticClass', obj.chromaticClass,...
                'preTime', obj.preTime, 'stimTime', obj.stimTime, ...
