classdef ConeContrastExp < edu.washington.riekelab.manookin.protocols.ManookinLabStageProtocol
    ...
    methods
        ...
        function prepareRun(obj)
            ...
            for ii = 1:length(x)
              if strcmp(obj.temporalClass, 'sinewave')
                stimValues(1,ii) = sin(obj.temporalFrequency * x(ii) * 2 * pi) * obj.backgroundIntensity + obj.backgroundIntensity;
              elseif strcmp(obj.temporalClass, 'squarewave')
                stimValues(1,ii) = sign(sin(obj.temporalFrequency * x(ii) * 2 * pi)) * obj.backgroundIntensity + obj.backgroundIntensity;
              end
            end
        ...
        function p = createPresentation(obj)
            ...
            if strcmp(obj.stageClass, 'Video')
                ...
                spot.color = obj.colorWeights(1)*obj.backgroundIntensity + obj.backgroundIntensity;
            end
