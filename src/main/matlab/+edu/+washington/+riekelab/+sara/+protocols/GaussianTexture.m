classdef GaussianTexture < edu.washington.riekelab.sara.protocols.SaraStageProtocol
    properties
        ...
        outerRadius = 0                 % Outer mask radius in pixels.
    ...
    methods
        ...
        function p = createPresentation(obj)
            ...
            if obj.outerRadius > 0
                ...
                sz = (obj.um2pix(obj.outerRadius)*2) / min(obj.canvasSize);
                if sz < 1
                    ...
                    [x,y] = meshgrid(...
                        linspace(-obj.canvasSize(1)/2,obj.canvasSize(1)/2,obj.canvasSize(1)), ...
                    ...
                    circle = uint8((distanceMatrix >= obj.um2pix(obj.outerRadius)) * 255);
