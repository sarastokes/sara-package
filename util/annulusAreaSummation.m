...
o = params(1).*(1 - exp(-(outerRadius.^2)./params(2))) - params(3).*(1 - exp(-(outerRadius.^2)./params(4)));

r = params(1).*(1 - exp(-(radii(1:end-1).^2)./params(2))) - params(3).*(1 - exp(-(radii(1:end-1).^2)./params(4)));
